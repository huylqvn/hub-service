...
type Session interface {
	...
	SetUser(c echo.Context, User *model.User) error
	GetUser(c echo.Context) *model.User
}
...
func (s *session) SetUser(c echo.Context, user *model.User) error {
	return s.SetValue(c, User, user)
}

func (s *session) GetUser(c echo.Context) *model.User {
